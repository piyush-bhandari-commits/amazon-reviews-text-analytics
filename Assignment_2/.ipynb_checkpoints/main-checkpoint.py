...
def main(dir_path):
    ...
    # print (data_with_stopwords['train'][:5])
    # data_with_stopwords['valid'] = read_csv(data_path['valid_with_stopwords'])
    # data_with_stopwords['test'] = read_csv(data_path['test_with_stopwords'])
