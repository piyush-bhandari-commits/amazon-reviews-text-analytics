...
def main():
    ...
    data_with_stopwords = neg_tokens_with_stopwords + pos_tokens_with_stopwords
    create_csv(data_with_stopwords, 'out_with_stopwords')

    data_without_stopwords = neg_tokens_without_stopwords + pos_tokens_without_stopwords
    create_csv(data_without_stopwords, 'out_without_stopwords')

    train_data_with_stopwords = neg_train_with_stopwords + pos_train_with_stopwords
    create_csv(train_data_with_stopwords, 'train_data_with_stopwords')
    valid_data_with_stopwords = neg_valid_with_stopwords + pos_valid_with_stopwords
    create_csv(valid_data_with_stopwords, 'valid_data_with_stopwords')
    test_data_with_stopwords = neg_test_with_stopwords + pos_test_with_stopwords
    create_csv(test_data_with_stopwords, 'test_data_with_stopwords')

    train_data_without_stopwords = neg_train_without_stopwords + pos_train_without_stopwords
    create_csv(train_data_without_stopwords, 'train_data_without_stopwords')
    valid_data_without_stopwords = neg_valid_without_stopwords + pos_valid_without_stopwords
    create_csv(valid_data_without_stopwords, 'valid_data_without_stopwords')
    test_data_without_stopwords = neg_test_without_stopwords + pos_test_without_stopwords
    create_csv(test_data_without_stopwords, 'test_data_without_stopwords')
